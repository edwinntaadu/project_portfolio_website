const data = [
    {
      ...
      answer: "It mostly depends on the type of project. But in general, I would need a fair idea of what you want, then we can take it from there."
    },
    {
      id: 2,
    ...
    },
    {
      ...
      answer: "Once again, this depends... But my prices are affordable so it won't be a problem."
    },
    {
      id: 3,
      question: "What's your payment plan?",
      answer: "Payment is divided into 3. An initial 30% upfront payment to get me started and once all the details of the project are set, 40% once the project is completed, and 30% once the project is delivered."
    },
    {
      id: 6,
